...
class DelegatedSignersClient:
    ...
    def create_clone_input_complete(self, store_id: str, body: T.CreateCloneInputRequest, signed_challenge: SignUserActionChallengeRequest) -> T.CreateCloneInputResponse:
        """
    ...
    def create_genesis_input_complete(self, store_id: str, body: T.CreateGenesisInputRequest, signed_challenge: SignUserActionChallengeRequest) -> T.CreateGenesisInputResponse:
        """
