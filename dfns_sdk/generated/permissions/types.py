...
class CreatePermissionRequest(TypedDict, total=False):
    ...
    operations: list[
        Literal[
            ...
            "Auth:Users:Delete",
            "Auth:UserGroups:Create",
            "Auth:UserGroups:Read",
            "Auth:UserGroups:Update",
            "Auth:UserGroups:Delete",
            "Auth:UserGroups:Members:Read",
            "Auth:UserGroups:Members:Add",
            "Auth:UserGroups:Members:Remove",
